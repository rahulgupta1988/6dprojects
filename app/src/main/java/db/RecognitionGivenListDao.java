...
/**
 * DAO for table "RECOGNITION_GIVEN_LIST".
 */
public class RecognitionGivenListDao extends AbstractDao<RecognitionGivenList, Void> {

    public static final String TABLENAME = "RECOGNITION_GIVEN_LIST";

    /**
     * Properties of entity RecognitionGivenList.<br/>
    ...
    public RecognitionGivenListDao(DaoConfig config) {
        super(config);
    }

    public RecognitionGivenListDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RECOGNITION_GIVEN_LIST\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RECOGNITION_GIVEN_LIST\"";
        db.execSQL(sql);
    }
     ...
     */
    @Override
    protected void bindValues(SQLiteStatement stmt, RecognitionGivenList entity) {
        stmt.clearBindings();
     ...
     */
    @Override
    public RecognitionGivenList readEntity(Cursor cursor, int offset) {
        RecognitionGivenList entity = new RecognitionGivenList( //
     ...
     */
    @Override
    public void readEntity(Cursor cursor, RecognitionGivenList entity, int offset) {
     ...
     */
    @Override
    protected Void updateKeyAfterInsert(RecognitionGivenList entity, long rowId) {
     ...
     */
    @Override
    public Void getKey(RecognitionGivenList entity) {
        return null;
    }
