...
/** 
 * DAO for table "GPWALLPOST".
*/
public class GPWALLPOSTDao extends AbstractDao<GPWALLPOST, String> {

    public static final String TABLENAME = "GPWALLPOST";

    /**
     * Properties of entity GPWALLPOST.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Isstorystatus = new Property(20, String.class, "isstorystatus", false, "ISSTORYSTATUS");
    };


    public GPWALLPOSTDao(DaoConfig config) {
        super(config);
    }
    
    public GPWALLPOSTDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GPWALLPOST\" (" + //
                ...
                "\"ISSTORYSTATUS\" TEXT);"); // 20: isstorystatus
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GPWALLPOST\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, GPWALLPOST entity) {
        stmt.clearBindings();
        ...
        String isstorystatus = entity.getIsstorystatus();
        if (isstorystatus != null) {
            stmt.bindString(21, isstorystatus);
        }
    }
    ...
    /** @inheritdoc */
    @Override
    public GPWALLPOST readEntity(Cursor cursor, int offset) {
        GPWALLPOST entity = new GPWALLPOST( //
            ...
            cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20) // isstorystatus
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, GPWALLPOST entity, int offset) {
        ...
        entity.setIsstorystatus(cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20));
     }
    
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(GPWALLPOST entity, long rowId) {
        return entity.getGpostid();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(GPWALLPOST entity) {
        if(entity != null) {
            return entity.getGpostid();
        } else {
            return null;
