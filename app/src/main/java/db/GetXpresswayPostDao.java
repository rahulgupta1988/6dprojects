...
/**
 * DAO for table "GET_XPRESSWAY_POST".
 */
public class GetXpresswayPostDao extends AbstractDao<GetXpresswayPost, String> {

    public static final String TABLENAME = "GET_XPRESSWAY_POST";

    /**
     * Properties of entity GetXpresswayPost.<br/>
    ...
    public GetXpresswayPostDao(DaoConfig config) {
        super(config);
    }

    public GetXpresswayPostDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GET_XPRESSWAY_POST\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GET_XPRESSWAY_POST\"";
        db.execSQL(sql);
    }
     ...
     */
    @Override
    protected void bindValues(SQLiteStatement stmt, GetXpresswayPost entity) {
        stmt.clearBindings();
     ...
     */
    @Override
    public GetXpresswayPost readEntity(Cursor cursor, int offset) {
        GetXpresswayPost entity = new GetXpresswayPost( //
     ...
     */
    @Override
    public void readEntity(Cursor cursor, GetXpresswayPost entity, int offset) {
     ...
     */
    @Override
    protected String updateKeyAfterInsert(GetXpresswayPost entity, long rowId) {
     ...
     */
    @Override
    public String getKey(GetXpresswayPost entity) {
        if (entity != null) {
            return entity.getRecognition_id();
        } else {
            return null;
