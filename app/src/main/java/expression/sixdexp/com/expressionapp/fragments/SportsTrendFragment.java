 ...
 */
public class SportsTrendFragment extends android.support.v4.app.Fragment {
...
//        trendingtypetxt.setText("Sports");
    ...
    protected class TrendingBackTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            responseString = new WhatsTrendingManager(mContext).callForWhatsTrending("sports");
            return null;
        }
