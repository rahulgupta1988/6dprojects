 ...
 */
public class GeneralTrendframent extends android.support.v4.app.Fragment {
    Context mContext;
    View view;
...
//        trendingtypetxt.setText("General");
    ...
    protected class TrendingBackTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            responseString = new WhatsTrendingManager(mContext).callForWhatsTrending("general");
            return null;
        }
