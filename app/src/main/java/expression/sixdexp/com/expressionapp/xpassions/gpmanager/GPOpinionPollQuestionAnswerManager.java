...
public class GPOpinionPollQuestionAnswerManager extends BaseManager {
    ...
    public GPOpinionPollQuestionAnswerManager(Context context) {
        this.context = context;

    }

    public GPOpinionPollQuestionAnswerManager(Context context,String sinlgegid,String pollid) {
        this.context = context;
        this.sinlgegid=sinlgegid;
        this.pollid=pollid;

    }

    public String callOpinionQA() {
        ...
        try {
            ...
            Log.i("responstring", "coi_GetOpinionPollQuestionAnswer serviceUrl-->" + Constant.BASEURL + "api/OpinionPoll/coi_GetOpinionPollQuestionAnswer");
            ...
            responseString = ServerCall.makeConnection(Constant.BASEURL, entitymap, "api/OpinionPoll/coi_GetOpinionPollQuestionAnswer");

            if (responseString != null)
                Log.i("GP_PollQuestionAnswer", "responseString=" + responseString);
        } catch (Exception e) {
            e.printStackTrace();
        }
