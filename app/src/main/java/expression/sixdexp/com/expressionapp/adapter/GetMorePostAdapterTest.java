 ...
 */
public class GetMorePostAdapterTest extends RecyclerView.Adapter<GetMorePostAdapterTest.PostHolder> {
    ...
    public GetMorePostAdapterTest(Context context, MorePostInterface listener, String postID) {
        mContext = context;
    ...
    @Override
    public void onBindViewHolder(final PostHolder postHolder, final int position) {

        final int pos = position;
        final GetMorePost getMorePost = getMorePosts.get(position);
...
/*
        ...
        final String postid = getMorePosts.get(pos).getRecognition_id();
