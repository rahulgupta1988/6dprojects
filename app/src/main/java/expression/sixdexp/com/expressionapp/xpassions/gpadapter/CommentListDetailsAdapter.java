...
public class CommentListDetailsAdapter extends BaseAdapter {
    LayoutInflater layoutInflater;
    Context _mContext;
    List<Comments> commentses;

    public CommentListDetailsAdapter(Context context,boolean submitComment) {
        _mContext=context;


        if(submitComment)
            commentses=new GpPostCommentManager(_mContext).getCommentsList();
        else
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final CommentListDetailsAdapter.ViewHolder holder;
        if(convertView==null){
            holder = new CommentListDetailsAdapter.ViewHolder();
            ...
            holder = (CommentListDetailsAdapter.ViewHolder) convertView.getTag();
        }
