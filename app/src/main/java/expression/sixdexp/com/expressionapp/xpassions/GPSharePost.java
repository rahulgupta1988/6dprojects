...
import expression.sixdexp.com.expressionapp.xpassions.gpmanager.GPSharePostManager;
...
public class GPSharePost extends Activity implements View.OnClickListener
{
...
//        setContentView(R.layout.shareanupdateviewtab);
        setContentView(R.layout.gpshareview);
        mContext = this;
...
/* builder2.setIcon(R.drawable.ac_type);*/
   ...
   /*     nominatorimg = (RoundedImageView) findViewById(R.id.nominatorimg);
        ...
        if(GropuActionManager.gpActionModel.getMxway().equals("1"))
        { xpwayimg.setVisibility(View.VISIBLE);}
        else{xpwayimg.setVisibility(View.GONE);}
...
//                location_place_txt.setText(data.getStringExtra("Location Address"));
    ...
    public class PostShare extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                responseString = new GPSharePostManager(mContext).postUpdateShare(file_name, base64, viddoclink, sharedtxt+place_location,
    ...
    public class GetWallPostTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            // TODO Auto-generated method stub
            try {
                responseString = new GPWallPostManager(mContext).callGPWallPost(coi_gid);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
...
*/
                 ...
                 /*   Intent intent=new Intent(getApplicationContext(), GroupHome.class);
...
*/
    ...
    public class GetXpWallPostTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            // TODO Auto-generated method stub
            try {
                responseString = new XPGPWallPostManager(mContext).callxpGPWallPost(coi_gid);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
