...
import expression.sixdexp.com.expressionapp.xpassions.gpmanager.GPPollDetailsManager;
...
public class GPOtherPollDetailsActivty extends Activity {
    ...
    public class GetPollQA extends AsyncTask<String, Void, Void> {
        ...
        GPPollDetailsManager gpPollDetailsManager = null;
        ...
        protected Void doInBackground(String... params) {
            // TODO Auto-generated method stub
            try {
                gpPollDetailsManager = new GPPollDetailsManager(mContext);
                responseString = gpPollDetailsManager.callOpinionDetails(pollid);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
        ...
        protected void onPostExecute(Void result) {
            ...
            if(responseString.equals("100")){
                ...
                if(GPPollDetailsManager.pollQAModel.getPollOptionModels()!=null) {
                    if (GPPollDetailsManager.pollQAModel.getPollOptionModels().size() > 0) {
                        String opinionpollid = GPPollDetailsManager.pollQAModel.getOpinionpollid();
                        String questiontitle = GPPollDetailsManager.pollQAModel.getQuestiontitle();
                        String noofparticipants = GPPollDetailsManager.pollQAModel.getNoofparticipants();
                        String isanswer = GPPollDetailsManager.pollQAModel.getIsanswer();
                        String polltype = GPPollDetailsManager.pollQAModel.getPolltype();
                        String end_date = GPPollDetailsManager.pollQAModel.getEnd_date();
    ...
    public void setTextAnserList(){
        ...
        List<PollOptionModel> pollOptionModels= GPPollDetailsManager.pollQAModel.getPollOptionModels();
