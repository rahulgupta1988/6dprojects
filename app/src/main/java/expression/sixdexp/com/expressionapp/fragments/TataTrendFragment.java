 ...
 */
public class TataTrendFragment extends android.support.v4.app.Fragment {
...
//        trendingtypetxt.setText("Tata World News");
    ...
    protected class TrendingBackTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            responseString = new WhatsTrendingManager(mContext).callForWhatsTrending("tataworldnews");
            return null;
        }
