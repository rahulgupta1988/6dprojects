...
/**
 * Created by Praveen on 03-Oct-17.
 */

public class SrisanTaggedUserManager extends BaseManager {

    Context context;
    String responseString = "";


    public SrisanTaggedUserManager(Context context) {
        this.context = context;

    }

    public String callTagedUser(String commentid, String policyid, String commentlevel,
        ...
        try {
            ...
            Log.i("childcommentid", childcommentid);
            ...
            if (responseString != null)
                Log.i("gettaguserlistsrijancom", "responseString=" + responseString);
        } catch (Exception e) {
            e.printStackTrace();
        }
