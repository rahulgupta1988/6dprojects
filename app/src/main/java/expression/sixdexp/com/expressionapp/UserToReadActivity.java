...
public class UserToReadActivity  extends AppCompatActivity {
        ...
        if(intent!=null){
            ...
            if(fromNotification!=null){
                if(fromNotification.equals("yes")){
                    user_name=new LoginManager(mContext).getUserInfoByID(userid).get(0).getName();
                }
                else{
    ...
    public void initViews() {
        ...
        toread_user.setText(user_name+"'s"+" Wishlist");
