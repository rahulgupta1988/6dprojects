...
public class GPWallPostManager extends BaseManager
{

    Context context;
    String responseString="";
    public GPWallPostManager (Context context) {
        this.context=context;

    }


    public String callGPWallPost(String coi_gid)
    {
        try {
    ...
    public String parseGPWallPostData(String jsonResponse)
    {
        ...
        daoSession.getGPWALLPOSTDao().deleteAll();
                    ...
                    if (jsonObject.has("responseCode"))
                    {
                        ...
                        if (responseCode.equalsIgnoreCase("100"))
                        {
                            ...
                            for(int i=0;i<jsonarray.length();i++) {
                                ...
                                gpwallpostDao.insertOrReplace(gpwallpost);
    ...
    public String callGPMoreWallPost(String coi_gid)
    {
        try {
            HashMap<String,String> entitymap=new HashMap<String,String>();
    ...
    public List<GPWALLPOST> getWallPosts()
    {
        DaoSession daoSession=getDBSessoin(context);
        GPWALLPOSTDao gpwallpostDao=daoSession.getGPWALLPOSTDao();
        try
        {
            List<GPWALLPOST> gpwallposts=new ArrayList<>();
            gpwallposts=gpwallpostDao.loadAll();
            return gpwallposts;
        }
        catch (Exception e){
            e.printStackTrace();
    ...
    public String getPostCountByDate()
    {
        ...
        List<GPWALLPOST>  getMorePosts=gpwallpostDao.loadAll();
        String postCount="0";
    ...
    public List<GPWALLPOST> getPostByPostID(String gpID){
