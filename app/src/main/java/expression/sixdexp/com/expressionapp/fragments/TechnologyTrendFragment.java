 ...
 */
public class TechnologyTrendFragment extends android.support.v4.app.Fragment {
    Context mContext;
    View view;
...
//        trendingtypetxt.setText("Technology");
    ...
    protected class TrendingBackTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            responseString = new WhatsTrendingManager(mContext).callForWhatsTrending("technology");
            return null;
        }
