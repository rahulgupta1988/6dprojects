...
public class OpinionPollQuestionAnswerManager extends BaseManager {
    ...
    public OpinionPollQuestionAnswerManager(Context context) {
    ...
    public String callOpinionQA() {
        ...
        try {
            ...
            Log.i("responstring", "GetOpinionPollQuestionAnswer serviceUrl-->" + Constant.BASEURL + "api/OpinionPoll/GetOpinionPollQuestionAnswer");
            entitymap.put("userid",userid);
            responseString = ServerCall.makeConnection(Constant.BASEURL, entitymap, "api/OpinionPoll/GetOpinionPollQuestionAnswer");

            if (responseString != null)
                Log.i("PollQuestionAnswer", "responseString=" + responseString);
        } catch (Exception e) {
            e.printStackTrace();
        }
