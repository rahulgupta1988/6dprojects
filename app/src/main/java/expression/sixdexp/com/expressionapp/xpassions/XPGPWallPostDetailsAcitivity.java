...
import expression.sixdexp.com.expressionapp.xpassions.gpadapter.XPGPWallPostAdapter_details;
...
public class XPGPWallPostDetailsAcitivity extends Activity implements View.OnClickListener {


    RecyclerView postlist;
    Context mContext;
    XPGPWallPostAdapter_details getMorePostAdapter;
    String postId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        Constant.singlePostList_xp_gp.clear();
    ...
    public void initView() {
        ...
        if (postId != null && !postId.equalsIgnoreCase("")) {
            Constant.singlePostList_xp_gp=new XPGPWallPostManager(mContext).getPostByPostID(postId);
            setPost();
            //new GetPost().execute();
        } else {
    ...
    public void setPost() {
        ...
        getMorePostAdapter = new XPGPWallPostAdapter_details(mContext, new XPGPWallPostAdapter_details.MorePostInterface() {
            @Override
