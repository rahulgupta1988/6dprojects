...
/**
 * Created by Praveen on 7/18/2016.
 */
public class SinglePostManager extends BaseManager {

    Context context;
    String responseString = "";

    public SinglePostManager(Context context) {
        this.context = context;

    }


    public String callPostExpressway(String postID) {

        try {

            HashMap<String, String> entitymap = new HashMap<String, String>();
            entitymap.put("userid", SharedPrefrenceManager.getUserID(context));
            entitymap.put("recongnize_id", postID);
...
*/
            Log.i("responstring", "getpostdetailbyid serviceUrl-->" + Constant.BASEURL + "api/userApi/getpostdetailbyid" + "&userid=" + SharedPrefrenceManager.getUserID(context) + "&recongnize_id=" + postID);
            responseString = ServerCall.makeConnection(Constant.BASEURL, entitymap, "api/userApi/getpostdetailbyid");
        ...
        return parsePostDataExpressway(responseString);
    }

    public String parsePostDataExpressway(String jsonResponse) {
        String responseCode = "";
                        ...
                        if (responseCode.equalsIgnoreCase("100")) {
                            ...
                            for (int i = 0; i < jsonarray.length(); i++) {
                              ...
                              /*  String totalrows = jsonObject1.optString("totalrows");*/
                                ...
                                GetXpresswayPost getXpresswayPost = new GetXpresswayPost(userid, nominator_name, nominator_designation,
                                ...
                                Constant.singlePostList1.add(getXpresswayPost);
    ...
    public String callPost(String postID) {
...
*/
        ...
        return parsePostData(responseString);
    }

    public String parsePostData(String jsonResponse) {
        String responseCode = "";
                        ...
                        if (responseCode.equalsIgnoreCase("100")) {
                            ...
                            for (int i = 0; i < jsonarray.length(); i++) {
                              ...
                              /*  String totalrows = jsonObject1.optString("totalrows");*/
                                ...
                                Constant.singlePostList.add(getMorePost);
    ...
    public String callReadNotification(String postID,String notificationmasterid) {
        try {
            HashMap<String, String> entitymap = new HashMap<String, String>();
            entitymap.put("userid", SharedPrefrenceManager.getUserID(context));
            entitymap.put("nid", postID);
            entitymap.put("notificationmasterid", notificationmasterid);
            Log.i("responstring", "getpostdetailbyid serviceUrl-->" + Constant.BASEURL + "api/userApi/readmarknotification" + " &userid=" + SharedPrefrenceManager.getUserID(context) + " &nid=" + postID
                    + " &notificationmasterid=" + notificationmasterid);
            responseString = ServerCall.makeConnection(Constant.BASEURL, entitymap, "api/userApi/readmarknotification");
            if (responseString != null)
                Log.i("responseString1", "responseString=" + responseString);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return parseReadNotificationData(responseString);
    }


    public String parseReadNotificationData(String jsonResponse) {
        String responseCode = "";
        try {
            if (jsonResponse != null && !jsonResponse.equals(null) &&  new InternetConnectionDetector(context).isConnectingToInternet()) {
                Object object = new JSONTokener(jsonResponse).nextValue();
                if (object instanceof JSONObject) {
                    ...
                    if (jsonObject.has("responseCode")) {
                        ...
                        if (responseCode.equalsIgnoreCase("100")) {
                            responseString = responseCode;
                           /* JSONArray jsonarray = jsonObject.getJSONArray("responseData");*/
                            Log.d("data",responseString.toString());
