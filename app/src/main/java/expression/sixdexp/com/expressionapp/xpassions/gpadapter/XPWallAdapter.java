...
import com.expression.ui.flipanimation.Travels;
...
import expression.sixdexp.com.expressionapp.xpassions.XPGPWallPostDetailsAcitivity;
...
import expression.sixdexp.com.expressionapp.xpassions.gpmanager.XPGPWallLikeManager;
...
public class XPWallAdapter extends BaseAdapter {
    /*Context mcontext;*/
    ...
    Context mContext;
    List<XPGPWALLPOST> getMorePosts;
    String videoid = "";
    ...
    GPXPWayFragment tabFragment1 = null;

    String gpID="";
    public XPWallAdapter(Context context, FlipViewController flipView, GPXPWayFragment tabFragment1) {
        ...
        this.postID = postID;
        if (postID.equals(""))
            getMorePosts = new XPGPWallPostManager(mContext).getxpWallPosts();
        else
            getMorePosts = Constant.singlePostList_xp_gp;//new GetMorePostManager(mContext).getPostsByPostID(postID);
...
//            layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.myfinal, parent, false);
        ...
        XPGPWALLPOST getMorePost = getMorePosts.get(position);
...
*/
        ...
        if(isnoatmember.equalsIgnoreCase("no")){
            ...
            commentit.setEnabled(false);
            likeit.setEnabled(false);
            unlikeit.setEnabled(false);
...
/*
        ...
        if (postType.equalsIgnoreCase("image") || postType.equalsIgnoreCase("image/jpeg")) {
                ...
                description.setMinLines(1);*/
                        ...
                        if (getdeviceInch() >= 4.9) {
                            ...
                            if (is_story.equals("1") || is_story.equals("2")) {
                                ...
                                if (isxpress.equalsIgnoreCase("1") && (postType.equalsIgnoreCase("image/jpeg") || postType.equalsIgnoreCase("video") || postType.equalsIgnoreCase("doc"))) {
                                    description.setMaxLines(3);
                                    description.setMinLines(1);
                                } else if (isxpress.equalsIgnoreCase("1")) {
                                    description.setMaxLines(11);
                                    description.setMinLines(1);
                                } else if (postType.equalsIgnoreCase("image/jpeg") || postType.equalsIgnoreCase("video") || postType.equalsIgnoreCase("doc")) {
...
/*
            ...
            description.setText(strMsg1);*/
                  ...
                  description.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent detailsActitivty = new Intent(mContext, XPGPWallPostDetailsAcitivity.class);
                            detailsActitivty.putExtra("postId", getMorePosts.get(pos).getGpostid());
                            Constant.lastposition_home = pos;
        ...
        likeit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new PostLike(getMorePosts.get(pos)).execute(Gpostid);
            }
        });
        ...
        if (!getMorePosts.get(position).getTagcount().equals("0")) {
            ...
            tag_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (postType.equalsIgnoreCase("image/jpeg") || postType.equalsIgnoreCase("video")) {
                        tagWondow(recogID, tag_icon, 300,getMorePosts.get(pos));
                    } else {
                        tagWondow(recogID, tag_icon, 500,getMorePosts.get(pos));
                    }
        ...
        likeicon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!getMorePosts.get(position).getLikes().equals("0")) {
                    ...
                    if (postType.equalsIgnoreCase("image/jpeg") || postType.equalsIgnoreCase("video")) {
                        likeWondow(recogID, likeicon, 300,getMorePosts.get(position));
                    } else {
                        likeWondow(recogID, likeicon, 500,getMorePosts.get(position));
                    }
                }
                   /* else {
                        likeicon.setEnabled(false);
        ...
        commenticon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!getMorePosts.get(position).getComments().equals("0")) {
                    ...
                    if (postType.equalsIgnoreCase("image/jpeg") || postType.equalsIgnoreCase("video")) {
                        commentWondow(recogID, commenticon, 300,getMorePosts.get(position));
                    } else {
                        commentWondow(recogID, commenticon, 500,getMorePosts.get(position));
                    }
                }
    ...
    public class PostLike extends AsyncTask<String, Void, Void> {
        ...
        String Gpostid = "";
        XPGPWALLPOST getMorePost = null;

        public PostLike(XPGPWALLPOST getMorePost) {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                Gpostid = params[0];
                responseString = new XPGPWallLikeManager(mContext).postLike(gpID,Gpostid);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
        ...
        protected void onPostExecute(Void result) {
            ...
            if (responseString.equals("100")) {
                List<XPGPWALLPOST> postlist;
                if (!postID.equalsIgnoreCase(""))
                    postlist = Constant.singlePostList_xp_gp;
                else
                    postlist = new XPGPWallPostManager(mContext).getPostByPostID(Gpostid);
    ...
    public class GetMorePostTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (responseString.equals("100")) {
                ...
                flipView1.setAdapter(new XPWallAdapter(mContext, flipView1, tabFragment1));
    ...
    public void tagWondow(final String recogID, ImageView likeicon, int windowsize,final XPGPWALLPOST getMorePost) {
    ...
    public void likeWondow(final String recogID, ImageView likeicon, int windowsize,final XPGPWALLPOST getMorePost) {
    ...
    public void commentWondow(final String recogID, final ImageView likeicon, int windowsize,final XPGPWALLPOST getMorePost) {
    ...
    public void giveCommentWindow(final String postid, ImageView commentit, final String commentscount1, final TextView commentscount, final XPGPWALLPOST getMorePost) {
        ...
        new AsyncTask<String, Void, Void>() {
            ...
            protected void onPostExecute(Void result) {
                ...
                progressDialog.dismiss();
                if (responseString.equals("100")) {
                    GPCommentListAdapter commentListAdapter = new GPCommentListAdapter(mContext, false);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(mContext);
    ...
    public class PostComment extends AsyncTask<String, Void, Void> {
        ...
        PostComment(RecyclerView commentlist, EditText commenttxt, CoordinatorLayout searchlayparent, String postid,
                    String commentscount1, TextView commentscount, XPGPWALLPOST getMorePost) {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                comment = params[0];
                responseString = new GPWallComentManager(mContext,true).postComment(comment, taggedUSerID.toString(),gpID,postid);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
        ...
        protected void onPostExecute(Void result) {
            ...
            if (responseString.equals("100")) {
                ...
                GPCommentListAdapter commentListAdapter = new GPCommentListAdapter(mContext, true);
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(mContext);
                commentlist.setLayoutManager(layoutManager);
                commentlist.setItemAnimator(new DefaultItemAnimator());
                commentlist.setAdapter(commentListAdapter);
                ...
                new GPWallComentManager(mContext,true).updateCommentsInPostList(comments.getCount());
