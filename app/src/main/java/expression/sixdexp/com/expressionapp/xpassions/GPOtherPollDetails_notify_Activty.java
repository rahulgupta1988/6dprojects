...
public class GPOtherPollDetails_notify_Activty extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(intent!=null) {
            ...
            gpID= intent.getStringExtra("gpID");
        }
        ...
        submit_vote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!OptionSelectedID.equals("0"))
                    new GPOtherPollDetails_notify_Activty.SubmitPoll().execute();
                else Toast.makeText(mContext,"Please select an option.",Toast.LENGTH_SHORT).show();
            }
        });

        if(!pollid.equals("0"))
            new GPOtherPollDetails_notify_Activty.GetPollQA().execute();
    }
    ...
    public class GetPollQA extends AsyncTask<String, Void, Void> {
        ...
        expression.sixdexp.com.expressionapp.xpassions.gpmanager.GPOpinionPollQuestionAnswerManager GPOpinionPollQuestionAnswerManager = null;
        ...
        protected Void doInBackground(String... params) {
            // TODO Auto-generated method stub
            try {
                GPOpinionPollQuestionAnswerManager = new GPOpinionPollQuestionAnswerManager(mContext,gpID,pollid);
    ...
    public class SubmitPoll extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            // TODO Auto-generated method stub
            try {
                GPVotePollManager = new GPVotePollManager(mContext,gpID);
    ...
    public class GetOtherPolls extends AsyncTask<String, Void, Void> {
        ...
        String responseString = "";
        expression.sixdexp.com.expressionapp.xpassions.gpmanager.GPOtherPoolMamager GPOtherPoolMamager = null;
...
// TODO Auto-generated method stub
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        GPInfoActivity.isFromNotify="yes";
        finish();
