...
import expression.sixdexp.com.expressionapp.xpassions.GPWallPostDetailsAcitivity;
...
public class WallAdapter extends BaseAdapter {
    ...
    WallFragment tabFragment1 = null;

    String gpID="";
    public WallAdapter(Context context, FlipViewController flipView, WallFragment tabFragment1) {
        ...
        this.postID = postID;
        if (postID.equals(""))
            getMorePosts = new GPWallPostManager(mContext).getWallPosts();
        else
...
//            layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.myfinal, parent, false);
        ...
        GPWALLPOST getMorePost = getMorePosts.get(position);
                  ...
                  /*  URLImageParser p = new URLImageParser(description, mContext);
                    ...
                    description.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent detailsActitivty = new Intent(mContext, GPWallPostDetailsAcitivity.class);
...
Log.i("is_story_status34",""+is_story_status);
        if(is_story_status.equals("1")){
            tag_count_txt.setVisibility(View.GONE);
            tag_icon.setVisibility(View.GONE);
        }

        else{
            tag_count_txt.setVisibility(View.VISIBLE);
            tag_icon.setVisibility(View.VISIBLE);
        }
        ...
        likeicon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!getMorePosts.get(position).getLikes().equals("0")) {
                    ...
                    if (postType.equalsIgnoreCase("image/jpeg") || postType.equalsIgnoreCase("video")) {
                        likeWondow(recogID, likeicon, 300,getMorePosts.get(pos));
                    } else {
                        likeWondow(recogID, likeicon, 500,getMorePosts.get(pos));
                    }
                }
                   /* else {
                        likeicon.setEnabled(false);
    ...
    public class PostLike extends AsyncTask<String, Void, Void> {
        ...
        public PostLike(GPWALLPOST getMorePost) {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (responseString.equals("100")) {
                ...
                if (!postID.equalsIgnoreCase(""))
                    postlist = Constant.singlePostList_gp;
                else
    ...
    public class GetMorePostTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (responseString.equals("100")) {
                ...
                flipView1.setAdapter(new WallAdapter(mContext, flipView1, tabFragment1));
    ...
    public void commentWondow(final String recogID, final ImageView likeicon, int windowsize,final GPWALLPOST getMorePost) {
    ...
    public void giveCommentWindow(final String postid, ImageView commentit, final String commentscount1, final TextView commentscount, final GPWALLPOST getMorePost) {
    ...
    public class PostComment extends AsyncTask<String, Void, Void> {
        ...
        PostComment(RecyclerView commentlist, EditText commenttxt, CoordinatorLayout searchlayparent, String postid,
                    String commentscount1, TextView commentscount, GPWALLPOST getMorePost) {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (responseString.equals("100")) {
                ...
                new GPWallComentManager(mContext,false).updateCommentsInPostList(comments.getCount());
