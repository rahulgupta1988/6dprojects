...
import expression.sixdexp.com.expressionapp.xpassions.gpadapter.GPOtherPollAdapter;
import expression.sixdexp.com.expressionapp.xpassions.gpmanager.GPOpinionPollQuestionAnswerManager;
import expression.sixdexp.com.expressionapp.xpassions.gpmanager.GPOtherPoolMamager;
import expression.sixdexp.com.expressionapp.xpassions.gpmanager.GPVotePollManager;
...
public class GPOpinionFragment extends Fragment{
    ...
    public GPOpinionFragment(){};
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mContext = getActivity();
        view = inflater.inflate(R.layout.poll_layout, container, false);
        initView();
        return view;
    }
    ...
    public void initView() {
        poll_lay=(LinearLayout)view.findViewById(R.id.poll_lay);
        no_data_txt=(TextView)view.findViewById(R.id.no_data_txt);
        current_poll_qt_txt=(TextView) view.findViewById(R.id.current_poll_qt_txt);
        voter_count=(TextView) view.findViewById(R.id.voter_count);
        date_time_txt=(TextView) view.findViewById(R.id.date_time_txt);

        current_poll_tab_lay=(RelativeLayout)view.findViewById(R.id.current_poll_tab_lay);
        other_poll_tab_lay=(RelativeLayout)view.findViewById(R.id.other_poll_tab_lay);

        scroll_view=(ScrollView)view.findViewById(R.id.scroll_view);
        submit_vote=(TextView)view.findViewById(R.id.submit_vote);
        current_poll_tab=(RelativeLayout)view.findViewById(R.id.current_poll_tab);
        other_poll_tab=(RelativeLayout)view.findViewById(R.id.other_poll_tab);
        current_tab_line=(View)view.findViewById(R.id.current_tab_line);
        other_tab_line=(View)view.findViewById(R.id.other_tab_line);
        ...
        current_poll_tab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if(current_tab_line.getVisibility()!=View.VISIBLE){
                    other_tab_line.setVisibility(View.INVISIBLE);
                    current_tab_line.setVisibility(View.VISIBLE);
                    other_poll_tab_lay.setVisibility(View.GONE);
                    current_poll_tab_lay.setVisibility(View.VISIBLE);
        ...
        other_poll_tab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if(other_tab_line.getVisibility()!=View.VISIBLE){
                    current_tab_line.setVisibility(View.INVISIBLE);
                    other_tab_line.setVisibility(View.VISIBLE);
                    current_poll_tab_lay.setVisibility(View.GONE);
                    other_poll_tab_lay.setVisibility(View.VISIBLE);
                    new GetOtherPolls().execute();
                }
        ...
        submit_vote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // for guest user
                if(!GropuActionManager.gpActionModel.getIsnoatmember().equalsIgnoreCase("no")){
    ...
    public void setQuestionList(){
        ...
        LinearLayout question_lay=(LinearLayout)view.findViewById(R.id.question_lay);
        question_lay.removeAllViews();
        LayoutInflater layoutInflater=(LayoutInflater) mContext.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);


        List<PollOptionModel> pollOptionModels= GPOpinionPollQuestionAnswerManager.pollQAModel.getPollOptionModels();
    ...
    public void setOtherPollList(){
        other_poll_list=(RecyclerView)view.findViewById(R.id.other_poll_list);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(mContext);
        other_poll_list.setLayoutManager(layoutManager);
        other_poll_list.setItemAnimator(new DefaultItemAnimator());
        other_poll_list.setAdapter(new GPOtherPollAdapter(mContext));
    }
    ...
    public class GetPollQA extends AsyncTask<String, Void, Void> {
        ...
        GPOpinionPollQuestionAnswerManager GPOpinionPollQuestionAnswerManager = null;
        ...
        protected Void doInBackground(String... params) {
            // TODO Auto-generated method stub
            try {
                GPOpinionPollQuestionAnswerManager = new GPOpinionPollQuestionAnswerManager(mContext);
                responseString = GPOpinionPollQuestionAnswerManager.callOpinionQA();
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
        ...
        protected void onPostExecute(Void result) {
            ...
            if(responseString.equals("100")){
                ...
                if(GPOpinionPollQuestionAnswerManager.pollQAModel.getPollOptionModels()!=null) {
                    if(GPOpinionPollQuestionAnswerManager.pollQAModel.getPollOptionModels().size()>0) {
                        no_data_txt.setVisibility(View.GONE);
                        poll_lay.setVisibility(View.VISIBLE);
                        String opinionpollid = GPOpinionPollQuestionAnswerManager.pollQAModel.getOpinionpollid();
                        String questiontitle = GPOpinionPollQuestionAnswerManager.pollQAModel.getQuestiontitle();
                        String noofparticipants = GPOpinionPollQuestionAnswerManager.pollQAModel.getNoofparticipants();
                        String isanswer = GPOpinionPollQuestionAnswerManager.pollQAModel.getIsanswer();
                        String polltype = GPOpinionPollQuestionAnswerManager.pollQAModel.getPolltype();
                        String end_date = GPOpinionPollQuestionAnswerManager.pollQAModel.getEnd_date();
    ...
    public class SubmitPoll extends AsyncTask<String, Void, Void> {
        ...
        String responseString = "";
        GPVotePollManager GPVotePollManager = null;
        ...
        protected Void doInBackground(String... params) {
            // TODO Auto-generated method stub
            try {
                GPVotePollManager = new GPVotePollManager(mContext);
                responseString = GPVotePollManager.callVotePoll(OptionSelectedID,pollid);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
    ...
    public class GetOtherPolls extends AsyncTask<String, Void, Void> {
        ...
        String responseString = "";
        GPOtherPoolMamager GPOtherPoolMamager = null;
        ...
        protected Void doInBackground(String... params) {
            // TODO Auto-generated method stub
            try {
                GPOtherPoolMamager = new GPOtherPoolMamager(mContext);
                responseString = GPOtherPoolMamager.callOtherPoll();
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
