...
public class SearchGroupsManager extends  BaseManager {
    ...
    public  SearchGroupsManager(Context _mContext){
        this._mContext = _mContext;
    }


    public String getGroups(String searchtext,String glastcount) {
        ...
        try {
            ...
            entitymap.put("mygroup","0");

            if(searchtext.length()>0)
                entitymap.put("searchtext",searchtext);
            else
