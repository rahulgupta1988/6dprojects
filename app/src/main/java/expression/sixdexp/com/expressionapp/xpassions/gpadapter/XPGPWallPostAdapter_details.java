...
/**
 * Created by Praveen on 16-Feb-18.
 */

public class XPGPWallPostAdapter_details extends RecyclerView.Adapter<XPGPWallPostAdapter_details.PostHolder> {

    Context mContext;
    List<XPGPWALLPOST> getMorePosts;
    String videoid = "";
    TextView likescountview;
    private XPGPWallPostAdapter_details.MorePostInterface listener;
    String postID = "";
    String postdate="";
    Typeface typeface;
    ...
    public XPGPWallPostAdapter_details(Context context, XPGPWallPostAdapter_details.MorePostInterface listener, String postID) {
        mContext = context;
    ...
    @Override
    public XPGPWallPostAdapter_details.PostHolder onCreateViewHolder(ViewGroup parent, int i) {
        ...
        return new XPGPWallPostAdapter_details.PostHolder(itemView);

    }

    @Override
    public void onBindViewHolder(final XPGPWallPostAdapter_details.PostHolder postHolder, final int position) {

        final int pos = position;
        final XPGPWALLPOST getMorePost = getMorePosts.get(position);
      ...
      /*  if (nominee_name1 != null && !nominee_name1.equalsIgnoreCase(""))
        ...
        if (details != null && !details.equalsIgnoreCase("")) {
         ...
         /*   if (postID.equals("")){
            ...
            postHolder.description.setOnTouchListener(new XPGPWallPostAdapter_details.LinkMovementMethodOverride());
            ...
            public void onClick(View v) {
               ...
               /* String postid = getMorePosts.get(pos).getGpostid();
                ...
                if (Gpostid != null && !Gpostid.equalsIgnoreCase(""))
                    likescountview = postHolder.likescount;
                new XPGPWallPostAdapter_details.PostLike(getMorePosts.get(pos)).execute(Gpostid);
...
/*
            ...
            if (position == getMorePosts.size() - 1) {
                ...
                postHolder.morepost.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        new XPGPWallPostAdapter_details.GetMorePostTask().execute();
                    }
                });
            }
    ...
    public void commentWondow(final String recogID, ImageView likeicon,int windowsize,final XPGPWALLPOST getMorePost) {
    ...
    private XPGPWallPostAdapter_details.EmoticonHandler mEmoticonHandler;
    EditText sharetxt_edit=null;

    public void setupImoticon(EditText sharetxt,ImageView emojiicon){
        sharetxt_edit=sharetxt;
        mEmoticonHandler = new XPGPWallPostAdapter_details.EmoticonHandler(sharetxt);
