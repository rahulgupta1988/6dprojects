 ...
 */
public class SingleLikeAndCommentManager extends BaseManager {
    ...
    public SingleLikeAndCommentManager(Context context) {
        _mContext = context;
    ...
    public String postLikeexpressway(String postID) {
        ...
        return parseLikeDataexpressway(responseString);
    }

    public String parseLikeDataexpressway(String jsonResponse) {
                ...
                if (object instanceof JSONObject) {
                    ...
                    if (jsonObject.has("responseCode")) {
                        ...
                        if (responseCode.equalsIgnoreCase("100")) {
                            ...
                            updateLikesexpressway(tlike, ulike, tcomment, ucomment);
                            updateLikesInPostexpressway(tlike, ulike, tcomment, ucomment);
                        } else {
    ...
    public void updateLikesexpressway(String tlike, String ulike, String tcomment, String ucomment) {

        try {

            Constant.singlePostList1.get(0).setLikes(tlike);
            Constant.singlePostList1.get(0).setUlikes(ulike);
            Constant.singlePostList1.get(0).setComments(tcomment);
            Constant.singlePostList1.get(0).setUcomments(ucomment);
    ...
    public void updateLikesInPostexpressway(String tlike, String ulike, String tcomment, String ucomment) {
        DaoSession daoSession = getDBSessoin(_mContext);
                ...
                if (object instanceof JSONObject) {
                    ...
                    if (jsonObject.has("responseCode")) {
                        ...
                        if (responseCode.equalsIgnoreCase("100")) {
                            ...
                            updateLikesInPost(tlike, ulike, tcomment, ucomment);
                        } else {
                            responseString = jsonObject.getString("responseData");
                        }
                    } else {
    ...
    public void updateLikes(String tlike, String ulike, String tcomment, String ucomment) {
        ...
        try {
            ...
            Constant.singlePostList.get(0).setLikes(tlike);
            Constant.singlePostList.get(0).setUlikes(ulike);
            Constant.singlePostList.get(0).setComments(tcomment);
            Constant.singlePostList.get(0).setUcomments(ucomment);
    ...
    public void updateLikesInPost(String tlike, String ulike, String tcomment, String ucomment) {
        DaoSession daoSession = getDBSessoin(_mContext);
    ...
    public void updateExpressComment(String tcomment, String recognizationId) {
        DaoSession daoSession = getDBSessoin(_mContext);
        GetXpresswayPostDao getXpresswayPostDao = daoSession.getGetXpresswayPostDao();
        ...
        try {
            ...
            if (getXpresswayPosts != null) {
                for (GetXpresswayPost post : getXpresswayPosts) {
                   /* int count=0;
                    try {
                        count=Integer.parseInt(post.getCount());
                        count=count+1;
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    post.setCount(String.valueOf(count));*/
                    post.setComments(tcomment);
                    getXpresswayPostDao.update(post);
                }
            }
