...
public class CommentListAdapter extends RecyclerView.Adapter<CommentListAdapter.CommentHolder>  {
    ...
    public CommentListAdapter(Context context,boolean submitComment) {
        _mContext=context;
        if(submitComment)
    ...
    @Override
    public void onBindViewHolder(final CommentListAdapter.CommentHolder holder, final int position) {
