...
public class TabFragmentFourthAapterPage extends BaseAdapter
{
    /*Context mcontext;*/
    ...
    List<GetXpresswayPost> getMorePosts;
    String videoid = "";
    ...
    public TabFragmentFourthAapterPage(Context context)
    {
        ...
        if (postID.equals("")){
            ...
            getMorePosts = new GetMorePostManager(mContext).getXpresswayPosts();
        }
        else
            getMorePosts = Constant.singlePostList1;//new GetMorePostManager(mContext).getPostsByPostID(postID);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        final TextView nominator_name,nominator_name_new, nominator_designation,nominator_designation_new,
                nominee_name, description, likescount, commentscount, event_date;
        final LinearLayout likeit, unlikeit;
        final ImageView commentit;
        LinearLayout xwicon;
        TextView xwsubject;
...
//            layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.myfinal, parent, false);
            layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.first_frag, parent, false);
        ...
        GetXpresswayPost getMorePost = getMorePosts.get(position);



                     /*  Start FloatingActionsMenu*/

        final FrameLayout frameLayout = (FrameLayout)layout.findViewById(R.id.frame_layout);
        frameLayout.getBackground().setAlpha(0);
        final FloatingActionsMenu fabMenu = (FloatingActionsMenu)layout.findViewById(R.id.fab_menu);
        ...
        final FloatingActionButton actionA = (FloatingActionButton)layout.findViewById(R.id.fab_search);
        ...
        final FloatingActionButton actionB = (FloatingActionButton)layout.findViewById(R.id.fab_recognize);
        ...
        final FloatingActionButton actionC = (FloatingActionButton)layout.findViewById(R.id.fab_shareupdate);
