...
public class OpinionPollFragment extends Fragment {
    ...
    public void setQuestionList() {
        ...
        List<PollOptionModel> pollOptionModels = OpinionPollQuestionAnswerManager.pollQAModel.getPollOptionModels();
    ...
    public class GetPollQA extends AsyncTask<String, Void, Void> {
        ...
        OpinionPollQuestionAnswerManager opinionPollQuestionAnswerManager = null;
        ...
        protected Void doInBackground(String... params) {
            // TODO Auto-generated method stub
            try {
                opinionPollQuestionAnswerManager = new OpinionPollQuestionAnswerManager(mContext);
                responseString = opinionPollQuestionAnswerManager.callOpinionQA();
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
        ...
        protected void onPostExecute(Void result) {
            ...
            if (responseString.equals("100")) {
                ...
                if (OpinionPollQuestionAnswerManager.pollQAModel.getPollOptionModels() != null) {
                    if (OpinionPollQuestionAnswerManager.pollQAModel.getPollOptionModels().size() > 0) {
