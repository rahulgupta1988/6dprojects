...
import placesautocomplete.adapter.AutoCompleteAdapter;
import placesautocomplete.model.PlacePredictions;
import placesautocomplete.utils.VolleyJSONRequest;
...
public class PickLocationActivity extends AppCompatActivity implements  Response.Listener<String>, Response.ErrorListener,  GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_main_final);
        ...
        searchBtn=(ProgressBar) findViewById(R.id.search);
  ...
  /*      else {
    ...
    public String getPlaceAutoCompleteUrl(String input) {
        ...
        urlString.append("&key=" + "AIzaSyC6lRBIOxTw25tWUA91uBtJkbd7-8uWMsM");
